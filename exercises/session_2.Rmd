...
We are going to walk you through the steps to make this scatter plot of life expectancy at birth vs. health expenditure per capita in 2015, using the data in `life_expectancy`:
