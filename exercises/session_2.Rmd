...
R functions contain a set of commands grouped together in order to perform a specific task that could not be run using built-in functions. In the example below, the function `sum_pow` takes two arguments, and sum their squared value. 
